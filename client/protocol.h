...
enum ENUM_TYPE{
    ...
    ENUM_TYPE_FLUSH_FRIEND_RESPONDT,
    ENUM_TYPE_DEL_USER_REQUEST,
    ENUM_TYPE_DEL_USER_RESPOND,
    ENUM_TYPE_CHAT_REQUEST,
    ENUM_TYPE_CHAT_RESEND,
    ENUM_TYPE_MKFILE_REQUEST,
    ENUM_TYPE_MKFILE_RESPOND,
...
PDU* mkPDU(uint uiMsgLen=0);//给消息默认长度设置为0
#endif // PROTOCOL_H
